...
def p_train(make_obs_ph_n, act_space_n, p_index, p_func, q_func,plan_func, optimizer, grad_norm_clipping=None, local_q_func=False,
...
class PGMADDPGAgentTrainer(AgentTrainer):
