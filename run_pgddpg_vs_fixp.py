...
flags.DEFINE_string('exp_name', '3v1_fixprey', 'exp_name')
flags.DEFINE_string('predator_policy', 'pgddpg', 'predator_policy') #laker
...
flags.DEFINE_string('prey_policy', 'fixpolicy', 'prey_policy: [random, fixed, ddpg]')
