...
flags.DEFINE_string('prey_model_path','./exp_result/3v1_dual/saved_models/round_up_base/seed_pgddpg_0.5/20200905143133/model-72000',#'./exp_result/3v1_dual/saved_models/round_up_reward_shaping/seed_ddpg/20200905143204/model-38000',  
...
# test for all model 
predator_model_path = ['./exp_result/3v1/saved_models/round_up_reward_shaping/seed_maddpg/20200907225448/model-32000',
                       './exp_result/3v1/saved_models/round_up_reward_shaping_5/seed_ddpg/20200907225232/model-32000',
                       './exp_result/3v1/saved_models/round_up_reward_shaping_10/seed_ddpg/20200907225208/model-34000',
                       './exp_result/3v1/saved_models/round_up_reward_shaping_10/seed_maddpg/20200907225553/model-36000',
                       './exp_result/3v1/saved_models/round_up_reward_shaping_100/seed_ddpg/20200907225405/model-32000',
                       './exp_result/3v1/saved_models/round_up_reward_shaping_100/seed_maddpg/20200907225642/model-40000',
                        ]
prey_model_path = []
# test policy
predator_policy = ['maddpg','ddpg','ddpg','maddpg','ddpg','maddpg']
prey_policy = ['fixpolicy','fixpolicy','fixpolicy','fixpolicy','fixpolicy','fixpolicy',]
...
# flags.DEFINE_string('prey_policy', 'fixpolicy', 'prey_policy: [random, fixed, ddpg, fixpolicy]')
flags.DEFINE_integer('episodes', 100, 'maximum training episode')
...
def train():
    ...
    for i in range(len(predator_model_path)):
        ...
        losses_transformation_file_name = log_path + '/' + prey_policy[i] + '_success_rate_mean_step.txt'
        with open(losses_transformation_file_name, 'a') as fp:
            fp.write(pa_model_path +"\t\t"+ pe_model_path +"\t\t"+ str(sum(sucess_rate)/len(sucess_rate)) +"\t\t"+ str(np.mean(episode_step_r))+"\n")#predator prey success_rate episode_step
