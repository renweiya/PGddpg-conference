...
flags.DEFINE_string('env_name', 'round_up_pg', 'env used')#round_up_base
...
# flags.DEFINE_string('predator_model_path','./exp_result/3v1_dual/saved_models/round_up_reward_shaping/seed_ddpg/20200905143204/model-56000',#'./exp_result/3v1_dual/saved_models/round_up_base/seed_pgddpg_0.5/20200905143133/model-40000',#
                    # 'path of the pre-trained predator model')
# test for all model 
# predator_model_path = ['test_model/saved_models/model-prey-01/seed_ddpg/20200912103401/model-40000',
#                        'test_model/saved_models/model-prey-01/seed_maddpg/20200910205033/model-40000',
#                     #    'test_model/saved_models/model-prey-01/seed_pgddpg_0.8/pre_trained_prey_20200910200405/model-40000',
#                        'test_model/saved_models/model-prey-02/seed_ddpg/20200912103408/model-40000',
#                        'test_model/saved_models/model-prey-02/seed_maddpg/20200910205040/model-40000',
#                     #    'test_model/saved_models/model-prey-02/seed_pgddpg_0.8/pre_trained_prey_20200910200419/model-40000',
#                        "test_model/saved_models/model-prey-03/seed_ddpg/20200912103416/model-40000",
#                        "test_model/saved_models/model-prey-03/seed_maddpg/20200910205046/model-40000",
#                     #    "test_model/saved_models/model-prey-03/seed_pgddpg_0.8/pre_trained_prey_20200910200427/model-40000",
#                        "test_model/saved_models/model-prey-04/seed_ddpg/20200912103421/model-40000",
#                        "test_model/saved_models/model-prey-04/seed_maddpg/20200910205052/model-40000",
#                     #    "test_model/saved_models/model-prey-04/seed_pgddpg_0.8/pre_trained_prey_20200910200435/model-40000",
#                        "test_model/saved_models/model-prey-06/seed_ddpg/20200912103427/model-40000",
#                        "test_model/saved_models/model-prey-06/seed_maddpg/20200910205104/model-40000",
#                     #    "test_model/saved_models/model-prey-06/seed_pgddpg_0.8/pre_trained_prey_20200910200446/model-40000",
#                        "test_model/saved_models/model-prey-07/seed_ddpg/20200912103433/model-40000",
#                        "test_model/saved_models/model-prey-07/seed_maddpg/20200910205135/model-40000",
#                     #    "test_model/saved_models/model-prey-07/seed_pgddpg_0.8/pre_trained_prey_20200910200455/model-40000",
#                        "test_model/saved_models/model-prey-08/seed_ddpg/20200912103440/model-40000",
#                        "test_model/saved_models/model-prey-08/seed_maddpg/20200910205147/model-40000",
#                     #    "test_model/saved_models/model-prey-08/seed_pgddpg_0.8/pre_trained_prey_20200910200504/model-40000",
#                        "test_model/saved_models/model-prey-09/seed_ddpg/20200912103446/model-40000",
#                        "test_model/saved_models/model-prey-09/seed_maddpg/20200910205155/model-40000",
#                     #    "test_model/saved_models/model-prey-09/seed_pgddpg_0.8/pre_trained_prey_20200910200512/model-40000",
#                        "test_model/saved_models/model-prey-23/seed_ddpg/20200912103327/model-40000",
#                        "test_model/saved_models/model-prey-23/seed_maddpg/20200910205019/model-40000",
#                     #    "test_model/saved_models/model-prey-23/seed_pgddpg_0.8/pre_trained_prey_20200910200115/model-40000",
#                        "test_model/saved_models/model-prey-s/seed_ddpg/20200912103349/model-40000",
#                        "test_model/saved_models/model-prey-s/seed_maddpg/20200910205027/model-40000",
#                     #    "test_model/saved_models/model-prey-s/seed_pgddpg_0.8/pre_trained_prey_20200910204032/model-40000",
#                         ]
# prey_model_path = ['test_model/prey/model-prey-01',
#                                            'test_model/prey/model-prey-01',
#                                         #    'test_model/prey/model-prey-01',
#                                            'test_model/prey/model-prey-02',
#                                            'test_model/prey/model-prey-02',
#                                         #    'test_model/prey/model-prey-02',
#                                            'test_model/prey/model-prey-03',
#                                            'test_model/prey/model-prey-03',
#                                         #    'test_model/prey/model-prey-03',
#                                            'test_model/prey/model-prey-04',
#                                            'test_model/prey/model-prey-04',
#                                         #    'test_model/prey/model-prey-04',
#                                            'test_model/prey/model-prey-06',
#                                            'test_model/prey/model-prey-06',
#                                         #    'test_model/prey/model-prey-06',
#                                            'test_model/prey/model-prey-07',
#                                            'test_model/prey/model-prey-07',
#                                         #    'test_model/prey/model-prey-07',
#                                            'test_model/prey/model-prey-08',
#                                            'test_model/prey/model-prey-08',
#                                         #    'test_model/prey/model-prey-08',
#                                            'test_model/prey/model-prey-09',
#                                            'test_model/prey/model-prey-09',
#                                         #    'test_model/prey/model-prey-09',
#                                            'test_model/prey/model-prey-23',
#                                            'test_model/prey/model-prey-23',
#                                         #    'test_model/prey/model-prey-23',
...
def train():
    ...
    for i in range(len(predator_model_path)):
        ...
        # do record
        log_path = './exp_result/evaluate_record_pgpgpgpgpg'
        if not os.path.exists(log_path):
            os.makedirs(log_path, exist_ok=True)
        losses_transformation_file_name = log_path + '/' + pa_model_path.split("/")[3] + '_success_rate_mean_step.txt'
