...
#plt.plot(x,y)
#plt.sca(ax1)
plt.plot(zz, pgddpg_vs_prey01, label='pgddpg_vs_prey(max_speed = 0.3)', linewidth=1,linestyle = "dashed",
         color='R', marker='s',  markersize=5 , markerfacecolor='white')
plt.plot(zz, ddpg_vs_prey01, label='ddpg(rs)_vs_prey(max_speed = 0.3)', linewidth=1,linestyle = "dashed",
         color='r', marker='o',  markersize=5 , markerfacecolor='white')
#maddpg
plt.plot(zz, maddpg_vs_prey01, label='maddpg(rs)_vs_prey(max_speed = 0.3)', linewidth=1,linestyle = "dashed",
         color='r', marker='v',  markersize=5 , markerfacecolor='white')

plt.plot(zz, pgddpg_vs_prey02, label='pgddpg_vs_prey(max_speed = 0.5)', linewidth=1,linestyle = "dashed",
         color='b', marker='s',  markersize=5 , markerfacecolor='white')
plt.plot(zz, ddpg_vs_prey02, label='ddpg(rs)_vs_prey(max_speed = 0.5)', linewidth=1,linestyle = "dashed",
         color='b', marker='o',  markersize=5 , markerfacecolor='white')
plt.plot(zz, maddpg_vs_prey02, label='maddpg(rs)_vs_prey(max_speed = 0.5)', linewidth=1,linestyle = "dashed",
         color='b', marker='v',  markersize=5 , markerfacecolor='white')

plt.plot(zz, pgddpg_vs_prey03, label='pgddpg_vs_prey(max_speed = 0.7)', linewidth=1,linestyle = "dashed",
         color='g', marker='s',  markersize=5 , markerfacecolor='white')
plt.plot(zz, ddpg_vs_prey03, label='ddpg(rs)_vs_prey(max_speed = 0.7)', linewidth=1,linestyle = "dashed",
         color='g', marker='o',  markersize=5 , markerfacecolor='white')
plt.plot(zz, maddpg_vs_prey03, label='maddpg(rs)_vs_prey(max_speed = 0.7)', linewidth=1,linestyle = "dashed",
         color='g', marker='v',  markersize=5 , markerfacecolor='white')
...
plt.title('Prey00 With Different Speed',font2)
