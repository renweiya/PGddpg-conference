...
# test for all model 
predator_model_path = [
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-s/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-01/seed_pgddpg_0.8/pre_trained_prey_20210108101258/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-02/seed_pgddpg_0.8/pre_trained_prey_20210108101248/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-03/seed_pgddpg_0.8/pre_trained_prey_20210108101241/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-04/seed_pgddpg_0.8/pre_trained_prey_20210108101233/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-06/seed_pgddpg_0.8/pre_trained_prey_20210108101212/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-07/seed_pgddpg_0.8/pre_trained_prey_20210108101203/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-08/seed_pgddpg_0.8/pre_trained_prey_20210108101147/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-09/seed_pgddpg_0.8/pre_trained_prey_20210108101140/model-40000',
                        'test_model/predator/no-obs_pg_exp_0-9/model-prey-23/seed_pgddpg_0.8/pre_trained_prey_20210108101224/model-40000',
                        ]
prey_model_path = [
...
def train():
    for i in range(len(predator_model_path)):
        ...
        # do record
        log_path = './exp_result/evaluate_record_1000'
        ...
        with open(losses_transformation_file_name, 'a') as fp:
            fp.write(pa_model_path.split("/")[2] +"\t\t"+ pe_model_path.split("/")[2]  +"\t\t"+ str(sum(sucess_rate)/len(sucess_rate)) +"\t\t"+ str(np.mean(episode_step_r))+"\n")#predator prey success_rate episode_step
