...
flags.DEFINE_integer('max_step_before_punishment', 40, 'max_step_before_punishment')#modify 8
...
flags.DEFINE_string('prey_model_path', './exp_result/round_up/rounding/saved_models/seed_1/model-preyA',
...
flags.DEFINE_string('predator_model_path', './test_model/saved_models/model-prey-01/seed_maddpg/20200910205033/model-40000',
...
flags.DEFINE_string('predator_policy', 'ddpg_81', 'predator_policy') #laker #ddpg_81、ddpg_huibao
...
flags.DEFINE_integer('episodes', 50000, 'maximum training episode')#140000
flags.DEFINE_integer('max_episode_len', 40, 'maximum step of each episode')#modify 60
...
# experience replay
flags.DEFINE_integer('buffer_size', 30, 'buffer size')
flags.DEFINE_integer('min_buffer_size', 30, 'minimum buffer size before training')#laker 30000
...
# Net structure
flags.DEFINE_integer('num_units', 32, 'layer neuron number')#laker 32
